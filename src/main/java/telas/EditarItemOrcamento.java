 ...
 * @author F2258573
 */
public class EditarItemOrcamento extends javax.swing.JFrame {

    OrcamentoItem OrcamentoItem;
    ListaItensOrcamento  ListaItensOrcamento;
    public EditarItemOrcamento() {
        initComponents();
        
        setLocationRelativeTo(null);
    }
     public EditarItemOrcamento(OrcamentoItem Orcamentoitem, ListaItensOrcamento ListaItensOrcamento) {
        initComponents();
        TxtNome.setText(Orcamentoitem.getItem());
        TxtDescricao.setText(Orcamentoitem.getDescricao());
        String valor = String.valueOf(Orcamentoitem.getValor());
        ...
        this.ListaItensOrcamento =  ListaItensOrcamento;
           this.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosed(WindowEvent e) {
               ListaItensOrcamento.preenchertabela(); // Atualiza a tabela na tela principal
            }
        });
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        OrcamentoItem.setItem(Nome);
        OrcamentoItem.setValor(ValorInteiro);
        OrcamentoItemDAO.atualizar(OrcamentoItem);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarItemOrcamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarItemOrcamento().setVisible(true);
            }
        });
    }
