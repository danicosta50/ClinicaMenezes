 ...
 * @author F2258573
 */
public class OrcamentoItemTela extends javax.swing.JFrame {

    /**
     * Creates new form OrcamentoItemTela
     */
...
private void preenchertabela(){
    ...
    private void initComponents() {
        ...
        Selecionar.setBackground(new java.awt.Color(153, 153, 0));
        Selecionar.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrcamentoItemTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrcamentoItemTela().setVisible(true);
            }
        });
    }
